...
Chat IDs must be prefixed with their provider (e.g. `telegram:` or `discord:`).
...
See [Triggers and Mentions](../configuration/triggers.md) for full details on trigger behavior.
